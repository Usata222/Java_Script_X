...
//   var liText = document.createTextNode('Item 4');
...
function story(e){
  e.preventDefault();
   ...
   newbutt.className='btn btn-danger btn-sm float-right delete';
